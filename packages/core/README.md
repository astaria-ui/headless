...
```sh
bun create astro@latest -- --template integration
```
...
| Command       | Action                                                                                                                                                                                                                           |
| :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bun link`    | Registers this package locally. Run `bun link my-integration` in an Astro project to install your integration                                                                                                                    |
